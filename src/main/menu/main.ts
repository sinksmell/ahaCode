...
const helpMenuItems: MenuConfig[] = [
  ...
  },
  {
    ...
    click: () => {
      shell.openExternal('https://github.com/sinksmell/ahaCode')
    },
  },
  {
    label: i18n.t('menu:help.documentation'),
    click: () => {
      shell.openExternal('https://github.com/sinksmell/ahaCode#readme')
    },
  },
  {
    label: i18n.t('menu:help.twitter'),
    click: () => {
      shell.openExternal('https://github.com/sinksmell')
    },
  },
  {
    type: 'separator',
  ...
  },
  {
    ...
    click: () => {
      shell.openExternal('https://github.com/sinksmell/ahaCode/releases')
    },
  },
  {
    ...
    click: () => {
      shell.openExternal(
        'https://github.com/sinksmell/ahaCode/issues/new/choose',
      )
    },
  },
  {
    ...
    click: () => {
      shell.openExternal('https://github.com/sinksmell/ahaCode/stargazers')
    },
  },
  {
    type: 'separator',
